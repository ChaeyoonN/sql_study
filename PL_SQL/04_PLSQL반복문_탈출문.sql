...
BEGIN
    ...
    LOOP
        ...
        ELSE
            dbms_output.put_line(dan||'단'||'skip~');
            dbms_output.put_line('-----------------------------------');
        END IF;
    END LOOP;
END;
...
INSERT INTO board
VALUES(seq.NEXTVAL, 'test'||seq.NEXTVAL, 'title'||seq.NEXTVAL);
...
BEGIN
    ...
    LOOP
        INSERT INTO board
--        VALUES(v_count, 'test'||v_count, 'title'||v_count);
        VALUES(seq.NEXTVAL, 'test'||v_count, 'title'||v_count);
--        VALUES(seq.NEXTVAL, 'test'||seq.NEXTVAL, 'title'||seq.NEXTVAL);
        v_count := v_count +1; -- step
    END LOOP;
