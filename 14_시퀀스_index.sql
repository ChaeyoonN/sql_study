...
CREATE SEQUENCE dept2_seq
    ...
    MAXVALUE 10 -- 최댓값 (기본값은 증가일 때는 1027, 감소일 때는 -1)
    MINVALUE 1 -- 최솟값 (기본값 증가일 때 1, 감소일 때 -1028)
...
ALTER SEQUENCE dept2_seq MAXVALUE 9999; -- 최댓값 증가
ALTER SEQUENCE dept2_seq INCREMENT BY -1; -- 증가값 변경
ALTER SEQUENCE dept2_seq MINVALUE 0; -- 최솟값 변경
