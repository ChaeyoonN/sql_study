...
--L: SQL디벨로퍼에서 지정한 화폐단위 표현해주는 서식문자
...
SELECT TO_CHAR(TO_DATE('20050102', 'YYYYMMDD'), 'YYYY"년" MM"월" DD"일"') AS dateInfo
FROM dual;

-- NULL 형태를 변환하는 함수 NVL(컬럼, 변환할 타겟값) 변환할 타겟값은 컬럼(null아닌)과 같은 타입이어야
